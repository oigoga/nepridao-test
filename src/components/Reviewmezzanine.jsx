...
const Reviewmezzanine = () => {
  return (
    <>
      <div className="flex flex-col font-Montserrat my-4 border-dashed border-2 border-grey">
        <h4 className="font-extrabold text-black text-2xl mx-12 mt-4">Mezzanine</h4>
        <div className="flex justify-between w-full mx-12 my-5">
          <div className="bg-black h-96 w-1/2 flex items-center justify-center">
...
export default Reviewmezzanine;
